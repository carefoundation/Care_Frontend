  ...
  const fetchHomeData = async () => {
    try {
      ...
      if (data.hospitalPartners) {
        setHospitalPartners(data.hospitalPartners.map((partner: any) => {
          let photo = partner.photo || partner.logo;
          if (!photo && partner.formData) {
            if (partner.formData.banner) {
              photo = partner.formData.banner;
      ...
      if (data.medicinePartners) {
        setMedicinePartners(data.medicinePartners.map((partner: any) => {
          let photo = partner.photo || partner.logo;
          if (!photo && partner.formData) {
            if (partner.formData.banner) {
              photo = partner.formData.banner;
      ...
      if (data.pathologyPartners) {
        setPathologyPartners(data.pathologyPartners.map((partner: any) => {
          let photo = partner.photo || partner.logo;
          if (!photo && partner.formData) {
            if (partner.formData.banner) {
              photo = partner.formData.banner;
      ...
      <section className="py-16 bg-gray-50">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          {hospitalPartners.length > 0 && (
            <div className="mb-16">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Hospital Partners</h3>
              <div className="relative">
                {hospitalPartners.length > 1 && (
                  <>
                    <button
                      onClick={() => setHospitalPartnerIndex(Math.max(0, hospitalPartnerIndex - 1))}
                      disabled={hospitalPartnerIndex === 0}
                      className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        hospitalPartnerIndex === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronLeft className="h-6 w-6 text-gray-700" />
                    </button>
                    <button
                      onClick={() => {
                        ...
                        setHospitalPartnerIndex(Math.min(maxIndex, hospitalPartnerIndex + 1));
                      }}
                      disabled={hospitalPartnerIndex >= (isMobile ? hospitalPartners.length - 1 : hospitalPartners.length - 4)}
                      className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        hospitalPartnerIndex >= (isMobile ? hospitalPartners.length - 1 : hospitalPartners.length - 4) ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronRight className="h-6 w-6 text-gray-700" />
                    </button>
                ...
                <div className="overflow-hidden">
                  <div 
                    className="flex gap-6 transition-transform duration-300 ease-in-out"
                    style={{
                      transform: hospitalPartners.length > 1 
                        ? isMobile
                    ...
                    {hospitalPartners.map((partner) => (
                      <div key={partner._id || partner.id || Math.random()} className="flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]">
                        <Card 
                          hover 
                          className="overflow-hidden bg-white rounded-lg cursor-pointer h-full"
                          onClick={() => router.push(`/partners/hospital/${partner._id || partner.id}`)}
                        >
                          <div className="relative w-full h-48 bg-gray-100">
                            {(partner.photo || partner.logo) ? (
                              <Image
                          ...
                          <div className="p-5">
                            ...
                            {partner.programs && partner.programs.length > 0 && (
                              <div className="mb-3">
                                <h5 className="text-xs font-semibold text-gray-900 mb-2">Services:</h5>
                                <div className="flex flex-wrap gap-1.5">
                                  {partner.programs.slice(0, 4).map((program: string, index: number) => (
                                    <span
                                      key={index}
          ...
          {medicinePartners.length > 0 && (
            <div className="mb-16">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Medicine/Pharmacy Partners</h3>
              <div className="relative">
                {medicinePartners.length > 1 && (
                  <>
                    <button
                      onClick={() => setMedicinePartnerIndex(Math.max(0, medicinePartnerIndex - 1))}
                      disabled={medicinePartnerIndex === 0}
                      className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        medicinePartnerIndex === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronLeft className="h-6 w-6 text-gray-700" />
                    </button>
                    <button
                      onClick={() => {
                        ...
                        setMedicinePartnerIndex(Math.min(maxIndex, medicinePartnerIndex + 1));
                      }}
                      disabled={medicinePartnerIndex >= (isMobile ? medicinePartners.length - 1 : medicinePartners.length - 4)}
                      className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        medicinePartnerIndex >= (isMobile ? medicinePartners.length - 1 : medicinePartners.length - 4) ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronRight className="h-6 w-6 text-gray-700" />
                    </button>
                ...
                <div className="overflow-hidden">
                  <div 
                    className="flex gap-6 transition-transform duration-300 ease-in-out"
                    style={{
                      transform: medicinePartners.length > 1 
                        ? isMobile
                    ...
                    {medicinePartners.map((partner) => (
                      <div key={partner._id || partner.id || Math.random()} className="flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]">
                        <Card 
                          hover 
                          className="overflow-hidden bg-white rounded-lg cursor-pointer h-full"
                          onClick={() => router.push(`/partners/medicine/${partner._id || partner.id}`)}
                        >
                          <div className="relative w-full h-48 bg-gray-100">
                            {(partner.photo || partner.logo) ? (
                              <Image
          ...
          {pathologyPartners.length > 0 && (
            <div className="mb-16">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Pathology Lab Partners</h3>
              <div className="relative">
                {pathologyPartners.length > 1 && (
                  <>
                    <button
                      onClick={() => setPathologyPartnerIndex(Math.max(0, pathologyPartnerIndex - 1))}
                      disabled={pathologyPartnerIndex === 0}
                      className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        pathologyPartnerIndex === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronLeft className="h-6 w-6 text-gray-700" />
                    </button>
                    <button
                      onClick={() => {
                        ...
                        setPathologyPartnerIndex(Math.min(maxIndex, pathologyPartnerIndex + 1));
                      }}
                      disabled={pathologyPartnerIndex >= (isMobile ? pathologyPartners.length - 1 : pathologyPartners.length - 4)}
                      className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all ${
                        pathologyPartnerIndex >= (isMobile ? pathologyPartners.length - 1 : pathologyPartners.length - 4) ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'
                      }`}
                    >
                      <ChevronRight className="h-6 w-6 text-gray-700" />
                    </button>
                ...
                <div className="overflow-hidden">
                  <div 
                    className="flex gap-6 transition-transform duration-300 ease-in-out"
                    style={{
                      transform: pathologyPartners.length > 1 
                        ? isMobile
                    ...
                    {pathologyPartners.map((partner) => (
                      <div key={partner._id || partner.id || Math.random()} className="flex-shrink-0 w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]">
                        <Card 
                          hover 
                          className="overflow-hidden bg-white rounded-lg cursor-pointer h-full"
                          onClick={() => router.push(`/partners/pathology/${partner._id || partner.id}`)}
                        >
                          <div className="relative w-full h-48 bg-gray-100">
                            {(partner.photo || partner.logo) ? (
                              <Image
                          ...
                          <div className="p-5">
                            ...
                            {partner.programs && partner.programs.length > 0 && (
                              <div className="mb-3">
                                <h5 className="text-xs font-semibold text-gray-900 mb-2">Tests:</h5>
                                <div className="flex flex-wrap gap-1.5">
                                  {partner.programs.slice(0, 4).map((program: string, index: number) => (
                                    <span
                                      key={index}
